...
def service_add(institution_id):
    ...
    existe = institution.check_if_service_exists_by_name(institution_id, request.form.get("name"))
...
def service_edit(service_id):
    ...
    existe = institution.check_if_service_exists_by_name(service.institution_id, request.form.get("name"),service_id)
